 ...
 *   4. 错开（taken）：在 ±22px、4px 步长内平移竖直段的 x，取**与已排连线距离最大**者；
...
/* 2026-09-13 owner："密集排布时连线看不清" ⇒ 错开幅度 10→22px、步长 2→4px：
   并行线的间距从肉眼难分变成一眼能数，代价只是每条线多占几像素走廊（走廊宽 72，够用）。 */
const NUDGE: number[] = [0, 4, -4, 8, -8, 12, -12, 16, -16, 20, -20, 22, -22]

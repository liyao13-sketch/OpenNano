...
CANVAS_TOOL_DEFS = [
    Tool(
        ...
        parameters={"type": "object", "properties": {
            ...
            "machine_name": {"type": "string", "description": "可选:机台名或 tool_id,如 RIE200NL / ICP-PishowA"},
...
TOOLS: list[Tool] = [
    ...
    Tool(
        ...
        parameters={"type": "object", "properties": {
            ...
            "tool_id": {"type": "string", "description": "可选:机台过滤 RIE200NL/RIE10NR/ICP-PishowA/EBPG5200…"},
    ...
    Tool(
        ...
        parameters={"type": "object", "properties": {
            ...
            "tool_id": {"type": "string", "description": "可选:机台,如 RIE200NL/RIE10NR/ICP-PishowA"},
    ...
    Tool(
        ...
        parameters={"type": "object", "properties": {
            ...
            "tool_id": {"type": "string", "description": "可选:机台 RIE200NL/RIE10NR/ICP-PishowA…"},
